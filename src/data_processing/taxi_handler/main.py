...
def main():
    ...
    parser.add_argument("--clean-only", action="store_true", help="Only clean data, do not convert Parquet files")
    parser.add_argument("--check-only", action="store_true", help="Check and clean unprocessed files")
